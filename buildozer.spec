...
# (list) Permissions
android.permissions = INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,CAMERA,RECORD_AUDIO,WRITE_EXTERNAL_STORAGE,READ_EXTERNAL_STORAGE,FLASHLIGHT,MODIFY_AUDIO_SETTINGS,WAKE_LOCK,VIBRATE,ACCESS_NETWORK_STATE
...
# Use system SDK on GitHub Actions (has API 33 pre-installed)
...
# Build for 64-bit ARM only (modern Android standard)
# armeabi-v7a (32-bit) removed due to libffi linking issues with long double symbols
# See: BUILD_31_32_MILESTONE.md for details
...
# setup.py if you're using Poetry, but you need to set this to true to get the behaviour
#p4a.setup_py = false
